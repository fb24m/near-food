...
import { Title3, Subtitle1, Body1, Card, Button } from "@fluentui/react-components";
...
export const Good = (props: GoodProps): JSX.Element => (
	<Card className={styles.good + " container"}>
		...
		<Subtitle1 className={styles.title}><a href={`?page=good&index=${props.index}&catalog=${catalog}`}>{props.title}</a></Subtitle1>
